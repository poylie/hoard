...
class SalesOrderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SalesOrder entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "referenceNumber":"SAMPLE_TEXT", "transactionDate":"2020-01-01T00:00:00.000Z", "lastUpdated":"2020-01-01T00:00:00.000Z", "customer":"SAMPLE_TEXT", "status":null}""")).asJSON
            .check(status.is(201))
