...
describe('PurchaseOrder e2e test', () => {
    ...
    it('should load PurchaseOrders', () => {
        entityMenu.click();
        element.all(by.css('[routerLink="purchase-order"]')).first().click().then(() => {
            const expectVal = /Purchase Orders/;
    ...
    it('should load create PurchaseOrder dialog', () => {
        element(by.css('button.create-purchase-order')).click().then(() => {
            const expectVal = /Create or edit a Purchase Order/;
