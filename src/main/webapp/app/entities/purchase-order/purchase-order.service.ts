...
export class PurchaseOrderService {
    ...
    private resourceSearchUrl = 'api/_search/purchase-orders';
    ...
    private convert(purchaseOrder: PurchaseOrder): PurchaseOrder {
        ...
        copy.transactionDate = this.dateUtils
            .convertLocalDateToServer(purchaseOrder.transactionDate);

        copy.lastUpdated = this.dateUtils.toDate(purchaseOrder.lastUpdated);
        return copy;
    }
}
